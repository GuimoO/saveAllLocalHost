...
use PetanqueBundle\Entity\Player;
...
class PlayerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $players = $em->getRepository('PetanqueBundle:Player')->findAll();
    ...
    {
        $player = new Player();
        $form = $this->createForm('PetanqueBundle\Form\PlayerType', $player);
    ...
    {
        $deleteForm = $this->createDeleteForm($player);
        $editForm = $this->createForm('PetanqueBundle\Form\PlayerType', $player);
